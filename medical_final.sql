...
-------------------------------------------------------------------------------------------------
--## ACCOUNT
select now() as time, 'UUID_CHANGES FOR ACCOUNT STARTS' as msg;
...
--## GST_TAX
select now() as time, 'UUID_CHANGES FOR GST_TAX STARTS' as msg;
...
select now() as time, 'UUID_CHANGES FOR GST_TAX ENDS' as msg;
--## GST_TAX
